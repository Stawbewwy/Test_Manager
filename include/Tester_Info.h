...
{
    public: 
    int num_lines_down, num_ans_lines, test_num;
    std::string program_name, tester_name, input, ans;

    public:
    Tester_Info(int inp_num_lines_down, int inp_num_ans_lines, int inp_test_num, std::string inp_program_name , std::string inp_tester_name ,
                std::string inp_input, std::string inp_ans) 
            :   num_lines_down(inp_num_lines_down), num_ans_lines(inp_num_ans_lines), test_num(inp_test_num) ,program_name(inp_program_name), tester_name(inp_tester_name) 
